...
class UserAdmin(object):
    ...
    list_display = ('username', 'first_name','gender','email','role','deptname','is_staff')
    list_filter = ('username', 'first_name','gender','email','role','deptname','is_staff')
    search_fields = ('username', 'first_name','gender','email','role','deptname','is_staff')
    ordering = ('username',)
